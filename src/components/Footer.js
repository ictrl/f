      ...
      <div className='row footer'>
        ...
        <div className='col-sm-2'>
          ...
          <ul style={{ letterSpacing: '1.5px' }}>
            <li>
              <Link to='/catalog'>PRIVACY POLICY</Link>
            </li>
            <li>
              <Link to='/catalog'>CONTACT &amp; HELP</Link>
            </li>
            <li>
              <Link to='/catalog'>HOW IT WORKS</Link>
            </li>
          </ul>
        </div>
        <div className='col-sm-2'>
          ...
          <ul style={{ letterSpacing: '1.5px' }}>
            <li>
              <Link to='/catalog'>SHIPPING INFO</Link>
            </li>
            <li>
              <Link to='/catalog'>RETURN POLICY</Link>
            </li>
            <li>
