		...
		<Fragment>
			<div className="row" style={{ marginBottom: '3rem' }}>
				<div className="col-sm-12 center" style={{ marginBottom: '30px' }}>
					<h3>
						<strong style={{ color: '#ff9900' }}>CREATE YOUR OWN CANVA</strong>
					</h3>
				...
				>
					<div className="col-sm-4">
						<div className="card center canvas-card">
							<img src={require('../images/material-card-1.png')} alt="Avatar" style={{ width: '100%' }} />
							<h4>
								<b>Canvas</b>
							</h4>
							<p>
				...
				>
					<div className="col-sm-4">
						<div className="card center canvas-card">
							<img src={require('../images/material-card-2.png')} alt="Avatar" style={{ width: '100%' }} />
							<h4>
								<b>HD Metal</b>
							</h4>
							<p>
				...
				>
					<div className="col-sm-4">
						<div className="card center canvas-card">
							<img src={require('../images/material-card-3.png')} alt="Avatar" style={{ width: '100%' }} />
							<h4>
								<b>Acrylic</b>
							</h4>
							<p>
