  ...
  const handlers = e => {
    ...
    switch (e.target.tagName) {
      case "DIV":
        ...
        popupSize =
          e.target.childNodes[0].childNodes[0].nextSibling.textContent;
        console.log(popupSize);
        popupPrice =
          e.target.childNodes[0].childNodes[0].nextSibling.nextSibling
              ...
              <ReactFilestack
                ...
                onSuccess={res => {
                  if (productProperty.num === 1) {
                    ...
                    setDiv(
                      <div
                        className="row left-section"
                        style={{ display: "block" }}
                      >
                        <div className="col-sm-12">
                          <div
                            class="upload-image-preview split"
                            id="uploadImg"
                          >
                            <img src={url} alt="" />
                          </div>
                ...
                <div id="myModal" className="modal fade" role="dialog">
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ height: "48.6rem", width: "67.2rem" }}
                    >
                      <div
                        className=" row popup-window"
                        style={{ width: "90rem" }}
                      >
                        <div
                          id="MyAccountsTab"
                        ...
                        >
                              ...
                              <div data-target="#lA" data-toggle="tab">
                                <div className="center">
                                  <span className="account-type">
                                    <img
                                      src="https://dummyimage.com/60x35/bbbbbb/bbbbbb"
                                      alt="12 X 18"
                                    />
                                  </span>
                                  <br />
                            ...
                            <li style={{ cursor: "pointer" }}>
                              <div data-target="#lB" data-toggle="tab">
                                <div className="center">
                                  <span className="account-type">
                                    <img
                                      src="https://dummyimage.com/45x45/bbbbbb/bbbbbb"
                                      alt="12 X 18"
                                    />
                                  </span>
                                  <br />
                            ...
                            <li style={{ cursor: "pointer" }}>
                              <div data-target="#lC" data-toggle="tab">
                                <div className="center">
                                  <span className="account-type">
                                    <img
                                      src="https://dummyimage.com/79x35/bbbbbb/bbbbbb"
                                      alt="12 X 18"
                                    />
                                  </span>
                                  <br />
                          ...
                          >
                            ...
                            >
                              <div
                                className="center "
                                style={{ padding: "3rem 5rem 3rem 1rem" }}
                              >
                                <h3>Custom Size</h3>
                                <form action>
