...
export default function privacyPolicy() {
  return (
    <div className='conatiner'>
      <h1>Privacy Policy for Galleriq</h1>
      <p>
        At galleriq, accessible from https://galleriq.com, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by galleriq and how we use it.
      </p>
      <p>
        If you have additional questions or require more information about our Privacy
        Policy, do not hesitate to contact us through email at 1@2.com
      </p>
      <h2>Log Files</h2>
      <p>
        galleriq follows a standard procedure of using log files. These files log visitors
      ...
      <p>
        Like any other website, galleriq uses 'cookies'. These cookies are used to store
      ...
      <p>
        ...
        partners of galleriq. Our Privacy Policy was created with the help of the{' '}
      ...
      <p>
        ...
        appear on galleriq, which are sent directly to users' browser. They automatically
      ...
      <p>
        Note that galleriq has no access to or control over these cookies that are used by
        third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        galleriq's Privacy Policy does not apply to other advertisers or websites. Thus,
        ...
        practices and instructions about how to opt-out of certain options. You may find a
        complete list of these Privacy Policies and their links here: Privacy Policy
        Links.
      </p>
      <p>
      ...
      <p>
        galleriq does not knowingly collect any Personal Identifiable Information from
      ...
      <p>
        ...
        collect in galleriq. This policy is not applicable to any information collected
